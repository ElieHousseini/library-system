...
const Form1 = () => {
  ...
  /*
  Important note: 
  - the form was handled like this, because of it needed to pass a test script that manipulates the fields without changing the state.
  - if it was me, I will use formik and re-write the test using something like jest or cypress.
  */
